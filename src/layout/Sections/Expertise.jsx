...
const Expertise = () => {
  const expertisesArray = [
    ...
    },
    {
      ...
      Ich habe SQL bei der Erstellung von Datenbanken für verschiedene Anwendungen verwendet und dabei verschiedene Technologien wie MySQL, PostgreSQL und Microsoft SQL Server eingesetzt. 
      Ich habe auch Erfahrung in der Abfrage von Daten und in der Verwendung von SQL in Verbindung mit verschiedenen Programmiersprachen wie Python und C#.`,
      tags: ["MySQL", "Datenbank-Management", "SQL-Abfragen"],
    },
    {
      title: "C++",
      desc: `Während meines Studiums habe ich C++ gelernt und meine Kenntnisse durch die Entwicklung von kleinen Anwendungen wie Spiele und einfache Algorithmen vertieft. 
    ...
    {
      title: "C#",
      desc: `Während meiner Arbeit als Softwareentwickler habe ich umfangreiche Kenntnisse in C# erworben. Ich habe C# bei der Entwicklung von Anwendungen im Bereich der Webentwicklung und des Desktops verwendet. 
      Ich habe auch Erfahrung in der Entwicklung von Web-APIs und der Arbeit mit Datenbanken wie SQL Server und MongoDB.`,
      tags: ["SQL Server", "Desktopanwendungen"],
    },
  ];
